...
- [Bridging the Gaps Between Residual Learning, Recurrent Neural Networks and Visual Cortex](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/bridging-gap-resnet-rnn.md) [[arXiv](https://arxiv.org/abs/1604.03640)]
...
- [Sentence Level Recurrent Topic Model: Letting Topics Speak for Themselves](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/slrtm.md) [[arXiv](https://arxiv.org/abs/1604.02038)]
- [Achieving Open Vocabulary Neural Machine Translation with Hybrid Word-Character Models](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/open-vocab-nmt-hybrid-word-character.md) [[arXiv](http://arxiv.org/abs/1604.00788)]
- [Building Machines That Learn and Think Like People](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/building-machines-that-learn-and-think-like-people.md) [[arXiv](http://arxiv.org/abs/1604.00289)]
- A Semisupervised Approach for Language Identification based on Ladder Networks [[arXiv](http://arxiv.org/abs/1604.00317)]
- [Deep Networks with Stochastic Depth](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/stochastic-depth.md) [[arXiv](http://arxiv.org/abs/1603.09382)]
...
- [Latent Predictor Networks for Code Generation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/latent-predictor-networks.md) [[arXiv](http://arxiv.org/abs/1603.06744)]
...
- [Incorporating Copying Mechanism in Sequence-to-Sequence Learning](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/copynet.md) [[arXiv](http://arxiv.org/abs/1603.06393)]
- How NOT To Evaluate Your Dialogue System [[arXiv](http://arxiv.org/abs/1603.08023)]
- [Adaptive Computation Time for Recurrent Neural Networks](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/act-rnn.md) [[arXiv](http://arxiv.org/abs/1603.08983)]
...
- [A Character-level Decoder without Explicit Segmentation for Neural Machine Translation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/char-level-decoder.md) [[arXiv](http://arxiv.org/abs/1603.06147)]
...
- [Contextual LSTM (CLSTM) models for Large scale NLP tasks](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/clstm-large-scale.md) [[arXiv](http://arxiv.org/abs/1602.06291)]
...
- [Associative Long Short-Term Memory](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/associative-lstm.md) [[arXiv](http://arxiv.org/abs/1602.03032)]
- Generating images with recurrent adversarial networks [[arXiv](http://arxiv.org/abs/1602.05110)]
- [Exploring the Limits of Language Modeling](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/exploring-the-limits-of-lm.md) [[arXiv](http://arxiv.org/abs/1602.02410)]
- Swivel: Improving Embeddings by Noticing What’s Missing [[arXiv](http://arxiv.org/abs/1602.02215)]
- [WebNav: A New Large-Scale Task for Natural Language based Sequential Decision Making](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/webnav.md) [[arXiv](http://arxiv.org/abs/1602.02261)]
- [Efficient Character-level Document Classification by Combining Convolution and Recurrent Layers](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/efficient-char-level-document-classification-cnn-rnn.md) [[arXiv](http://arxiv.org/abs/1602.00367)]
...
- [Multi-Way, Multilingual Neural Machine Translation with a Shared Attention Mechanism](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/multi-way-nmt-shared-attention.md) [[arXiv](http://arxiv.org/abs/1601.01073)]
- [Recurrent Memory Network for Language Modeling](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/rmn-language-modeling.md) [[arXiv](http://arxiv.org/abs/1601.01272)]
