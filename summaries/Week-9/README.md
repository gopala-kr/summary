...
- [Outrageously Large Neural Networks: The Sparsely-Gated Mixture-of-Experts Layer](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/mixture-experts.md) [[OpenReview](https://openreview.net/forum?id=B1ckMDqlg)]
...
- [Adversarial Training Methods for Semi-Supervised Text Classification](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/adversarial-text-classification.md) [[arXiv](https://arxiv.org/abs/1605.07725)]
...
- [Third-Person Imitation Learning](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/third-person-imitation-learning.md) [[OpenReview](http://openreview.net/forum?id=B16dGcqlx)]
...
- [Reinforcement Learning with Unsupervised Auxiliary Tasks](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/rl-auxiliary-tasks.md) [[arXiv](https://arxiv.org/abs/1611.05397)]
...
- [#Exploration: A Study of Count-Based Exploration for Deep Reinforcement Learning](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/count-based-exploration.md) [[arXiv](https://arxiv.org/abs/1611.04717)]
- Learning to Compose Words into Sentences with Reinforcement Learning [[OpenReview](http://openreview.net/forum?id=Skvgqgqxe)]
...
- [Google's Multilingual Neural Machine Translation System: Enabling Zero-Shot Translation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/gnmt-multilingual.md) [[arXiv](https://arxiv.org/abs/1611.04558)]
- [Neural Machine Translation with Reconstruction](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/nmt-with-reconstruction.md) [[arXiv](https://arxiv.org/abs/1611.01874v1)]
...
- [Dual Learning for Machine Translation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/dual-learning-mt.md) [[arXiv](https://arxiv.org/abs/1611.00179)]
...
- [Neural Machine Translation in Linear Time](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/nmt-linear-time.md) [[arXiv](https://arxiv.org/abs/1610.10099)] [[code](https://github.com/tensorflow/tensor2tensor)]
- [Professor Forcing: A New Algorithm for Training Recurrent Networks](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/professor-forcing.md) [[arXiv](https://arxiv.org/abs/1610.09038)]
...
- [Using Fast Weights to Attend to the Recent Past](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/fast-weight-to-attend.md) [[arXiv](https://arxiv.org/abs/1610.06258)]
- [Fully Character-Level Neural Machine Translation without Explicit Segmentation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/conv-char-level-nmt.md) [[arXiv](https://arxiv.org/abs/1610.03017)]
- [Diverse Beam Search: Decoding Diverse Solutions from Neural Sequence Models](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/diverse-beam-search.md) [[arXiv](https://arxiv.org/abs/1610.02424)]
...
- [Learning to Translate in Real-time with Neural Machine Translation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/learning-to-translate-real-time.md) [[arXiv](https://arxiv.org/abs/1610.00388)]
...
- [Pointer Sentinel Mixture Models](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/pointer-sentinel-mixture.md) [[arXiv](https://arxiv.org/abs/1609.07843)]
...
- [SeqGAN: Sequence Generative Adversarial Nets with Policy Gradient](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/seq-gan.md) [[arXiv](https://arxiv.org/abs/1609.05473)]
...
- [Hierarchical Multiscale Recurrent Neural Networks](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/hm-rnn.md) [[arXiv](https://arxiv.org/abs/1609.01704)]
...
- [Learning Online Alignments with Continuous Rewards Policy Gradient](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/online-alignments-pg.md) [[arXiv](https://arxiv.org/abs/1608.01281)]

#### 2016-07

- [An Actor-Critic Algorithm for Sequence Prediction](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/actor-critic-sequence.md) [[arXiv](http://arxiv.org/abs/1607.07086)]
...
- [Recurrent Neural Machine Translation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/recurrent-nmt.md) [[arXiv](http://arxiv.org/abs/1607.08725)]
- MS-Celeb-1M: A Dataset and Benchmark for Large-Scale Face Recognition [[arXiv](http://arxiv.org/abs/1607.08221)]
- [Layer Normalization](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/layer-norm.md) [[arXiv](https://arxiv.org/abs/1607.06450)]
- [Neural Machine Translation with Recurrent Attention Modeling](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/nmt-rec-attention.md)  [[arXiv](https://arxiv.org/abs/1607.05108)]
- Neural Semantic Encoders [[arXiv](https://arxiv.org/abs/1607.04315)]
- [Attention-over-Attention Neural Networks for Reading Comprehension](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/att-over-att.md) [[arXiv](https://arxiv.org/abs/1607.04423)]
...
- [Sequence-Level Knowledge Distillation](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/seq-knowledge-distillation.md) [[arXiv](https://arxiv.org/abs/1606.07947)]
...
- [SQuAD: 100,000+ Questions for Machine Comprehension of Text](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/squad.md) [[arXiv](http://arxiv.org/abs/1606.05250)]
...
- [Progressive Neural Networks](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/progressive-nn.md) [[arXiv](http://arxiv.org/abs/1606.04671)]
...
- [End-to-end LSTM-based dialog control optimized with supervised and reinforcement learning](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/e2e-dialog-control-sl-rl.md) [[arXiv](https://arxiv.org/abs/1606.01269)]
...
- [Natural Language Comprehension with the EpiReader](https://github.com/dennybritz/deeplearning-papernotes/tree/master/notes/epireader.md) [[arXiv](https://arxiv.org/abs/1606.02270)]
